...
## Phase 1: 基盤・ドキュメント（#8〜#10, #57）

| # | タイトル | Labels | 対応US | Size |
|---|---------|--------|--------|------|
| 8 | ERD図の作成（Mermaid） | `phase:1`, `priority:high`, `type:docs` | - | `size:XS` |
| 9 | OpenAPI 仕様の作成 | `phase:1`, `priority:high`, `type:docs` | - | `size:S` |
...
| 33 | 通知生成 API + トリガー | `phase:4`, `priority:high`, `type:backend` | US-25 | `size:M` |
...
| F02 プロジェクト | US-04〜08 | #5〜6, #11 | projects/* | #10, #57, #11, #12 |
| F03 タスクCRUD | US-09〜12 | #7〜8, #10 | tasks/* | #6, #13〜16 |
| F04 カンバン | US-13〜15 | #7 | tasks/*/status, sort | #6, #17, #58, #18 |
...
| F13 通知 | US-25〜26 | #13 | notifications/* | #33, #59, #34, #35 |
